...
export const dict = {
  zh: {
    ...
    metrics: [
      ...
      { label: '专注五金散热器', value: '铝型材定制' },
      { label: '成熟供应链', value: '稳定交付' },
      { label: '诚信通金牌商家', value: '14年可验' },
    ],
    about: {
  ...
  en: {
    ...
    metrics: [{ label: 'Industry Focus', value: '20+ Years' }, { label: 'Hardware Heat Sinks', value: 'Aluminum Custom' }, { label: 'Mature Supply Chain', value: 'Stable Delivery' }, { label: 'Alibaba Gold Supplier', value: '14 Years' }],
  ...
  hi: {
    ...
    metrics: [{ label: 'उद्योग अनुभव', value: '20+ वर्ष' }, { label: 'हार्डवेयर हीट सिंक', value: 'कस्टम एल्युमिनियम' }, { label: 'परिपक्व सप्लाई चेन', value: 'स्थिर डिलीवरी' }, { label: 'Alibaba Gold Supplier', value: '14 वर्ष' }],
  ...
  de: {
    ...
    metrics: [{ label: 'Branchenerfahrung', value: '20+ Jahre' }, { label: 'Hardware-Kühlkörper', value: 'Alu-Sonderteile' }, { label: 'Reife Lieferkette', value: 'Stabile Lieferung' }, { label: 'Alibaba Gold Supplier', value: '14 Jahre' }],
